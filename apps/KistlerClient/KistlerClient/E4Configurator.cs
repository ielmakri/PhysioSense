                        ...
                        else
                        {
                            foreach (var streamer in Streamers)
                            {
                                ...
                                && ss.Length == streamer.NbChannel + 2)
                                {
                                    ...
                                    {
                                        streamer.NewSample(tagSample, Streamer.ConvertUnixEpoch2LSL(Double.Parse(ss[1])));
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            dataSample[k] = Double.Parse(ss[k + 2]);
                                        }
                                        string[] strDataValues = new string[streamer.NbChannel];
                                        Array.Copy(ss, 2, strDataValues, 0, streamer.NbChannel);

                                        streamer.NewSample(dataSample, Streamer.ConvertUnixEpoch2LSL(Double.Parse(ss[1])));
                                    }
                                    break;
                                }
                            }
