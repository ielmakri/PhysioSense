...
AugmentX - Submodule: Dashboarding using Tig-stack from https://github.com/huntabyte/tig-stack.git  which is reconfigured for receiving UDP messages from DataManager app. 
